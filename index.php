        ...
        <div class="col-md-8">
          <div class="card">
            <div class="card-body text-center">
              <h4  class="title mb-2">ALLBINS AMAZON - code tio chap<img src="" class="rounded" width="65"</h4>
              <textarea style="height: 8.06rem;" class="form-control text-center form-checker mb-2" placeholder="INSIRA SUA LISTA"></textarea>
              ...
              <button class="btn btn-danger btn-stop text-white" style="width: 49%; float: right;" disabled><i class="fa fa-stop"></i> PARAR</button>
                              <input type="text" class="input_text blackbb text-white form-control" id="cookie1" name="cookie" value="" placeholder="COOKIE AMAZON.COM"   style="warning: 35%; float: left;">
            </div>
          </div>
        </div>
        <div class="col-md-4">
...
Swal.fire({
  ...
  confirmButtonColor: "#3CB371",
    ...
    $('.btn-play').click(function() {
      ...
      if (total > 50000) {
        Swal.fire({
          title: 'Limite de 50000 Linhas Exedido!',
          icon: 'warning',
          showConfirmButton: false,
          toast: true,
          position: 'top-end',
